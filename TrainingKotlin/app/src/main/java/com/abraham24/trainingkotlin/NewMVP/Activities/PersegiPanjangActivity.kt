...
class PersegiPanjangActivity : AppCompatActivity(), PresenterViewFormula {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_hitung.setOnClickListener {
            ...
            presenterFormula?.hitungPersegiPanjang(edit_text_1?.text.toString(), edit_text_2?.text.toString())
        }
